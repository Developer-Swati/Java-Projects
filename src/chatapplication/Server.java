...
public class Server implements ActionListener{
   ...
   JScrollPane jtp = new JScrollPane();
        ...
        // Adding Scrollbar
      /* jtp.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
       jtp.setBounds(420, 75, 30, 520);
       f.add(jtp);*/
    ...
    public void actionPerformed(ActionEvent ae){
      ...
      a1.setLayout(new BorderLayout());// can add component at top, below,right and left as well as center
    ...
    public static void main(String args[]){
        new Server();
        try{
            ServerSocket skt = new ServerSocket(6001); //To make this class Server use ServerSocket class 6001 is port no.
            while(true){
                Socket s = skt.accept();
